...
class BusinessSettingsController extends Controller
{
    ...
    public function update(Request $request)
    {
        ...
        //         $photos[] = $path;
        //     }
        //     // Save the paths in the database, if required
        //     // Example: Saving in BusinessSetting with type 'gallery_images'
        //     $business_settings = BusinessSetting::firstOrCreate(['type' => 'gallery_images']);
        //     $business_settings->value = json_encode($photos);
        //     $business_settings->save();
        // }
        Artisan::call('cache:clear');
