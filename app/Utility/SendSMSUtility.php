...
class SendSMSUtility
{
    ...
    {        
        ...
        elseif (OtpConfiguration::where('type', 'mimsms')->first()->value == 1) {
            ...
            //   curl_close($ch);
            //   return $response;
            $to = str_ireplace("+88", "", $to);
            
            $curl = curl_init();

            curl_setopt_array($curl, array(
                CURLOPT_URL => 'http://103.69.149.50/api/v2/SendSMS?ApiKey=2mrCDUAE4E55L8CXYjhoDV1ksh8we%2FA7Js2PtgZukcs%3D&ClientId=2db6f1c4-9125-4ca0-946a-073c37f39bb1&SenderId=8809617612641&Message=' . urlencode($text) . '&MobileNumbers=88' . $to . '&Is_Unicode=true',
                CURLOPT_RETURNTRANSFER => true,
                CURLOPT_ENCODING => '',
                CURLOPT_MAXREDIRS => 10,
                CURLOPT_TIMEOUT => 0,
