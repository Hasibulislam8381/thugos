    ...
    <div class="card">
        ...
        <form class="p-4" action="{{ route('custom-pages.update', $page->id) }}" method="POST"
            ...
            <div class="card-body px-0">
                ...
                {{-- Photo --}}
                @if ($page->type == 'about_page')
                    <div class="form-group row">
                        <label class="col-sm-2 col-from-label" for="image">{{ translate('Image') }}</label>
                        <div class="col-sm-10">
                            <div class="input-group " data-toggle="aizuploader" data-type="image">
                                ...
                                <input type="hidden" name="image" class="selected-files" value="{{ $page->image }}">
                            </div>
