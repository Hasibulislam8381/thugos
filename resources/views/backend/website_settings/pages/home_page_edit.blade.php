        ...
        <div class="col-xl-10 mx-auto">
            ...
            <div class="card">
                <div class="card-header">
                    <h6 class="mb-0">{{ translate('Home Slider') }} (828px * 368px)</h6>
                </div>
                <div class="card-body">
            ...
            <div class="card">
                <div class="card-header">
                    <h6 class="mb-0">{{ translate('Home Banner  (Max 1)') }}</h6>
                </div>
                <div class="card-body">
                    <form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
                            <label>{{ translate('Banner & Links') }}[1450x560]</label>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
                            <label>{{ translate('Banner & Links') }}[469x345]</label>
            ...
            <div class="card">
                <div class="card-header">
                    <h6 class="mb-0">{{ translate('Home Gallery') }} (1450x1750)</h6>
                </div>
                <div class="card-body">
                    <div class="alert alert-info">
                        {{ translate('We have limited banner height to maintain UI. We had to crop from both left & right side in view for different devices to make it responsive. Before designing banner keep these points in mind.') }}
                    ...
                    <form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label>{{ translate('Photos & Links') }}</label>
                            <div class="home-gallery-target">
                                <input type="hidden" name="types[]" value="home_gallery_images">
                                <input type="hidden" name="types[]" value="home_gallery_links">
                                @if (get_setting('home_gallery_images') != null)
                                    @foreach (json_decode(get_setting('home_gallery_images'), true) as $key => $value)
                                        <div class="row gutters-5">
                                            <div class="col-md-5">
                                                <div class="form-group">
                                                    <div class="input-group" data-toggle="aizuploader" data-type="image">
                                                        ...
                                                        <div class="form-control file-amount">
                                                            {{ translate('Choose File') }}</div>
                                                        <input type="hidden" name="types[]" value="home_gallery_images">
                                                        <input type="hidden" name="home_gallery_images[]"
                                                            class="selected-files"
                                                            value="{{ json_decode(get_setting('home_gallery_images'), true)[$key] }}">
                                                    </div>
                                                    <div class="file-preview box sm">
                                                    </div>
                                                </div>
							...
							<div class="row gutters-5">
								<div class="col-md-5">
									<div class="form-group">
										<div class="input-group" data-toggle="aizuploader" data-type="image">
											...
											<div class="form-control file-amount">{{ translate('Choose File') }}</div>
											<input type="hidden" name="types[]" value="home_gallery_images">
											<input type="hidden" name="home_gallery_images[]" class="selected-files">
										</div>
										<div class="file-preview box sm">
										</div>
									</div>
								...
								<div class="col-md">
									<div class="form-group">
										<input type="hidden" name="types[]" value="home_gallery_links">
										<input type="text" class="form-control" placeholder="http://" name="home_gallery_links[]">
									</div>
								</div>
								<div class="col-md-auto">
									<div class="form-group">
                                ...
                                data-target=".home-gallery-target">
                                {{ translate('Add New') }}
                            </button>
                        </div>
                        <div class="text-right">
            ...
            <div class="card">
                <div class="card-header">
                    <h6 class="mb-0">{{ translate('Customer Review') }} (720x1280)</h6>
                </div>
                <div class="card-body">
                    ...
                    <form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label>{{ translate('Photos & Links') }}</label>
                            <div class="home-gallery-target">
                                <input type="hidden" name="types[]" value="home_customer_review">
                                <input type="hidden" name="types[]" value="home_customer_links">
                                @if (get_setting('home_customer_review') != null)
                                    @foreach (json_decode(get_setting('home_customer_review'), true) as $key => $value)
                                        <div class="row gutters-5">
                                            <div class="col-md-5">
                                                <div class="form-group">
                                                    <div class="input-group" data-toggle="aizuploader" data-type="image">
                                                        ...
                                                        <input type="hidden" name="types[]"
                                                            value="home_customer_review">
                                                        <input type="hidden" name="home_customer_review[]"
                                                            class="selected-files"
                                                            value="{{ json_decode(get_setting('home_customer_review'), true)[$key] }}">
                                                    </div>
                                                    <div class="file-preview box sm">
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md">
                                                <div class="form-group">
                                                    <input type="hidden" name="types[]" value="home_customer_links">
                                                    <input type="text" class="form-control" placeholder="http://"
                                                        name="home_customer_links[]"
                                                        value="{{ json_decode(get_setting('home_customer_links'), true)[$key] }}">
                                                </div>
                                            </div>
                                            <div class="col-md-auto">
                                                <div class="form-group">
							...
							<div class="row gutters-5">
								<div class="col-md-5">
									<div class="form-group">
										<div class="input-group" data-toggle="aizuploader" data-type="image">
											...
											<div class="form-control file-amount">{{ translate('Choose File') }}</div>
											<input type="hidden" name="types[]" value="home_customer_review">
											<input type="hidden" name="home_customer_review[]" class="selected-files">
										</div>
										<div class="file-preview box sm">
										</div>
									</div>
								...
								<div class="col-md">
									<div class="form-group">
										<input type="hidden" name="types[]" value="home_customer_links">
										<input type="text" class="form-control" placeholder="http://" name="home_customer_links[]">
									</div>
								</div>
								<div class="col-md-auto">
									<div class="form-group">
