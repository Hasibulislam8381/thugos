                    ...
                    <div class="card shadow-none bg-light">
                        ...
                        <div class="card-body">
                            <form action="{{ route('business_settings.update') }}" method="POST"
                                ...
                                <div class="form-group">
                                    <label>{{ translate('Bkash account number') }}</label>
                                    <input type="hidden" name="types[]" value="bkash">
                                    <input type="text" class="form-control" placeholder="{{ translate('bkash') }}"
                                        name="bkash" value="{{ get_setting('bkash') }}">
                                </div>
                                <div class="form-group">
                                    <label>{{ translate('Nagad account number') }}</label>
                                    <input type="hidden" name="types[]" value="nagad">
                                    <input type="text" class="form-control" placeholder="{{ translate('nagad') }}"
                                        name="nagad" value="{{ get_setting('nagad') }}">
                                </div>
                                <div class="form-group">
                                    <label>{{ translate('Rocket account number') }}</label>
                                    <input type="hidden" name="types[]" value="rocket">
                                    <input type="text" class="form-control" placeholder="{{ translate('rocket') }}"
                                        name="rocket" value="{{ get_setting('rocket') }}">
                                </div>
                                <div class="form-group">
        ...
        <form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="card-body">
                ...
                <div class="card shadow-none bg-light">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            <label>{{ translate('Payment Methods') }} <small>(3200x390)</small> </label>
