        ...
        <form class="form form-horizontal mar-top" action="{{ route('products.update', $product->id) }}" method="POST"
            ...
            <div class="row gutters-5">
                <div class="col-lg-8">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                <label class="col-md-3 col-form-label"
                                    for="signinSrEmail">{{ translate('Gallery Images') }}<small>(500x600)</small></label>
                                <div class="col-md-8">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-8">
                                    <select class="form-control aiz-selectpicker" name="video_provider"
                                        ...
                                        <option value="facebook" <?php if ($product->video_provider == 'facebook') {
                                            echo 'selected';
                                        } ?>>{{ translate('Facebook') }}</option>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                <label class="col-lg-3 col-from-label">{{ translate('Ingredients') }} <i
                                        class="las la-language text-danger"
                                        title="{{ translate('Translatable') }}"></i></label>
                                <div class="col-lg-9">
                                    <textarea class="aiz-text-editor" name="ingredients">{{ $product->getTranslation('ingredients', $lang) }}</textarea>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-lg-3 col-from-label">{{ translate('FAQ') }} <i
                                        class="las la-language text-danger"
                                        title="{{ translate('Translatable') }}"></i></label>
                                <div class="col-lg-9">
                                    <textarea class="aiz-text-editor" name="faq">{{ $product->getTranslation('faq', $lang) }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h5 class="mb-0 h6">{{ translate('Quantity Offer') }}</h5>
                        </div>
                        <div class="card-body">
                            @php
                                $quantity_offer_json = json_decode($product->offer_quantity);
                            @endphp
                            @if ($quantity_offer_json)
                                @foreach ($quantity_offer_json as $quantity_offer)
                                    <div class="row mt-3">
                                        <div class="row">
                                            <div class="form-group col-lg-5">
                                                <label for="">Quantity:</label>
                                                <input type="text" name="offer_quantity[]" class="form-control"
                                                    placeholder="Enter Office Name" id=""
                                                    value="{{ $quantity_offer->quantity }}">
                                            </div>
                                            <div class="form-group col-lg-6">
                                                <label for="">Discount:</label>
                                                <input type="number" name="offer_discount[]" class="form-control"
                                                    placeholder="Enter Phone" value="{{ $quantity_offer->discount }}">
                                            </div>
                                            <div class="col-md-1">
                                                <img style="margin-top: 28px;margin-left:-26px"
                                                    onclick="removeNewRow(this)"
                                                    src="{{ static_asset('icon/close.png') }}" alt=""
                                ...
                                @endforeach
                            @endif
                            <span class="contact_field row"></span>
                            <div class="row mt-3">
                                <div class="col-md-12">
...
@section('script')
    ...
    <script>
        function addContactRow() {
            ...
            newRow.className = 'col-md-12 pl-0 pr-0';
            // Set the inner HTML of the new row
            newRow.innerHTML = `<div class="row">
                                        
                <div class="form-group col-lg-5">
                                                <label for="">Quantity:</label>
                                                <input type="text" name="offer_quantity_new[]" class="form-control"
                                                    placeholder="Enter Quantity" id="">
                                            </div>
                                            <div class="form-group col-lg-6">
                                                <label for="">Discount:</label>
                                                <input type="number" name="offer_discount_new[]" class="form-control"
                                                placeholder="Enter Discount">
                                            </div>
                                            <div class="form-group col-lg-1">
                                            <img style="cursor:pointer;margin-top:28px;margin-left:-26px" src="{{ static_asset('icon/close.png') }}" alt="Remove" class="remove-btn" onclick="removeRow(this)">
                                        </div>
                                    </div>`;
        ...
        function removeRow(image) {
            var row = image.closest('.contact_field');
            row.parentNode.removeChild(row);
        }
    </script>
@endsection
