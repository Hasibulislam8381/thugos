    ...
    <form class="" id="sort_products" action="" method="GET">
        <div class="card-header row gutters-5">
            ...
            <div class="dropdown mb-2 mb-md-0 mr-2">
                <select class="form-control" name="paginate" onchange="get_value(this.value)">
                    <option value="">--</option>
            ...
            <div class="col-md-2">
                <div class="form-group mb-0">
                    <input type="text" class="form-control form-control-sm" id="search" name="search"@isset($sort_search) value="{{ $sort_search }}" @endisset placeholder="{{ translate('Search Here...') }}">
                </div>
            </div>
...
@section('script')
    <script type="text/javascript">
        ...
        function get_value(val){
            window.location.href="?paginate="+val;
        }
