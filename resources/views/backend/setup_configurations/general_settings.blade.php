            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('business_settings.update') }}" method="POST"
                        ...
                        <div class="form-group row">
                            <label class="col-sm-3 col-from-label">{{ translate('Delivery Charge Info') }}</label>
                            <div class="col-sm-9">
                                <input type="hidden" name="types[]" value="delevery_charge_info">
                                <textarea class="aiz-text-editor" name="delevery_charge_info">
