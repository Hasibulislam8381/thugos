...
@section('content')
    <div class="card">
        <div class="reset_customer mt-2 ml-2">
            <form action="{{ route('all_orders.customer_rank') }}" method="post">
                @csrf
                <button type="submit" class="btn btn-primary">{{ translate('customer rank reset') }}</button>
            </form>
        </div>
        <form class="" action="" id="sort_orders" method="GET">
            <div class="card-header row gutters-5">
                ...
                {{-- <div class="mr-2">
                    <select name="store_id" id="" class="form-control" onchange="enableBulkAction()">
                        <option value="">Select Store</option>
                        @foreach ($pathao_stores as $store)
                ...
                <div class="dropdown mb-2 mb-md-0">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        ...
                        <a id="sent_pathao" class="dropdown-item " href="#" onclick="bulk_send_steadfast()">
                            {{ translate('Send Steadfast') }}</a>
                ...
                <table class="table aiz-table mb-0">
                    <thead>
                        <tr>
                            ...
                            <th data-breakpoints="md">{{ translate('Consignment Id') }}</th>
...
@section('script')
    ...
    <script>
        function enableBulkAction() {
            ...
            var element = document.getElementById("sent_pathao");

            // Check if the element exists and it has the "disabled" class
            if (element && element.classList.contains("disabled")) {
                ...
                console.log("Element not found or already enabled");
            }
        }
    </script>
    <script>
