              ...
              <form class="p-4" action="{{ route('flash_deals.update', $flash_deal->id) }}" method="POST">
                @csrf
                  ...
                  <input type="hidden" name="lang" value="{{ $lang }}">
                    ...
                    <div class="form-group row">
                        <label class="col-md-3 col-form-label" for="signinSrEmail">{{ translate('Promo Image') }}
                          <small>(496x273)</small></label>
                        <div class="col-md-9">
                          <div class="input-group" data-toggle="aizuploader" data-type="image">
                            ...
                            <input type="hidden" name="p_image" value="{{ $flash_deal->p_image }}" class="selected-files">
                          </div>
