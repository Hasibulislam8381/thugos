                ...
                @if (Auth::user()->user_type == 'admin' || in_array('2', json_decode(Auth::user()->staff->role->permissions)))
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('product_bulk_export.index_view') }}" class="aiz-side-nav-link">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('auction.all_products') }}"
                                    class="aiz-side-nav-link {{ areActiveRoutes(['auction_products.edit', 'product_bids.show']) }}">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('wholesale-products.index') }}"
                                    class="aiz-side-nav-link {{ areActiveRoutes(['wholesale-products.edit', 'wholesale-products.show']) }}">
            ...
            @if (Auth::user()->user_type == 'admin' || in_array('12', json_decode(Auth::user()->staff->role->permissions)))
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('stock_request.admin_index') }}"
                                    class="aiz-side-nav-link {{ areActiveRoutes(['stock_request.admin_index', 'stock_request.admin_index']) }}">
                                    <span class="aiz-side-nav-text">{{ translate('Stock Request') }}</span>
                                    @if ($support_ticket > 0)
