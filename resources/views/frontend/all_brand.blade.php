...
<section class="mb-4">
    <div class="container">
        <div class="brand_box shadow-sm rounded px-3">
            <div class="row row-cols-xxl-6 row-cols-xl-5 row-cols-lg-4 row-cols-md-3 row-cols-2 gutters-10">
                @foreach ($brands as $brand)
                    <div class="col text-center">
                        <a href="{{ route('products.brand', $brand->slug) }}" class="d-block p-3 mb-1 mt-1 border border-light rounded hov-shadow-md bg-white">
