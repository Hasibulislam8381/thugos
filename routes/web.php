...
Route::post('/product/{id}/request-stock', 'ProductController@requestStock')->name('product.request-stock');
...
Route::post('/password-match', 'HomeController@match_pass')->name('password_match');
Route::post('/password-match-cart', 'HomeController@match_pass_cart')->name('password_cart_match');
Route::get('/check-password/{userId}', 'HomeController@check_pass')->name('check-password');
Route::get('/user-login', 'HomeController@user_login')->name('user_login');
Route::get('/users/login', 'HomeController@login')->name('user.login');
Route::get('/users/registration', 'HomeController@registration')->name('user.registration');
//Route::post('/users/login', 'HomeController@user_login')->name('user.login.submit');
Route::post('/users/login/cart', 'HomeController@cart_login')->name('cart.login.submit');
Route::get('/check-otp', 'HomeController@check_otp')->name('check_otp');
Route::get('/cron/flash-deal', 'FlashDealController@cron_flash_deal')->name('cron.flash-deal');
Route::get('/cron/flash-deal-start', 'FlashDealController@cron_flash_deal_start')->name('cron.flash-deal-start');


Route::post('/users/store_otp', 'HomeController@store_otp')->name('user.store_otp');
Route::post('/users/forgot-store-otp', 'HomeController@forgot_store_otp')->name('user.forgot_store_otp');
Route::post('/users/otp_login', 'HomeController@loginWithOtp')->name('user.otp_login');
Route::post('/users/otp_login_regis', 'HomeController@loginWithOtpRegis')->name('user.otp_login_regis');
Route::get('/register-page', 'HomeController@register_page')->name('user.register_page');
Route::post('/register_user', 'Auth\CustomRegistrationController@register_user')->name('register_user');
Route::post('/register_user_cart', 'Auth\CustomRegistrationController@register_user_cart')->name('register_user_cart');

Route::get('/forgot-user-login', 'HomeController@forgot_user_login')->name('forgot_user_login');
Route::get('/forgot-check-otp', 'HomeController@forgot_check_otp')->name('forgot_check_otp');

Route::get('/confirm-password', 'HomeController@confirm_password')->name('confirm_password');
Route::post('/update-password', 'HomeController@update_password')->name('forgot-password.update');

Route::post('/users/address', 'HomeController@user_address')->name('user.address');

//Home Page
Route::get('/', 'HomeController@index')->name('home');
Route::post('/home/section/featured', 'HomeController@load_featured_section')->name('home.section.featured');
Route::post('/home/section/best_selling', 'HomeController@load_best_selling_section')->name('home.section.best_selling');
Route::post('/home/section/top_client', 'HomeController@load_top_client_section')->name('home.section.top_client');
...
Route::post('/home/section/home_todays_deal', 'HomeController@load_home_todays_deal')->name('home.section.home_todays_deal');



Route::get('/todays-deal', 'HomeController@todays_deal')->name('todays_deal');

Route::post('/home/section/home_blog', 'HomeController@load_home_blog_section')->name('home.section.home_blog');
Route::post('/home/section/new_selling', 'HomeController@load_new_selling_section')->name('home.section.new_selling');
Route::post('/home/section/recently_viewed', 'HomeController@load_recently_viewed_section')->name('home.section.recently_viewed');
Route::post('/home/section/home_home_gallery', 'HomeController@load_home_home_gallery_section')->name('home.section.home_gallery');
Route::get('/all-client', 'HomeController@all_client')->name('all_client');
...
Route::post('/cart/show-notify-modal', 'CartController@showNotifyModal')->name('cart.showNotifyModal');
Route::post('/cart/addtocart', 'CartController@addToCart')->name('cart.addToCart');
Route::post('/cart/addtocart_temp', 'CartController@addtocart_temp')->name('cart.addToCartTemp');
...
Route::group(['prefix' => 'checkout', 'middleware' => ['user', 'unbanned']], function () {
    ...
    Route::post('/advance-payment', 'CheckoutController@advance_payment')->name('advance_payment');
...
Route::get('/customer-reviews', 'HomeController@all_reviews')->name('reviews');
...
Route::get('/best-selling', 'HomeController@best_selling')->name('best_selling');
Route::get('/todays-deal', 'HomeController@todays_deal')->name('todays_deal');
Route::get('/recently-viewed', 'HomeController@recently_viewed')->name('recently_viewed');
Route::get('/new-arrival', 'HomeController@new_arrival')->name('new_arrival');
...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::post('/orders/update_advance_payment_status', 'OrderController@update_advance_payment_status')->name('orders.update_advance_payment_status');
    ...
    Route::get('/product-bulk-export-view', 'ProductBulkUploadController@export_index')->name('product_bulk_export.index_view');
    Route::get('/product-bulk-export', 'ProductBulkUploadController@export')->name('product_bulk_export.index');
    Route::get('/product-bulk-download', 'ProductBulkUploadController@download_excel')->name('product_bulk_export.index_download');
    Route::get('/product-bulk-download-date-wise', 'ProductBulkUploadController@download_excel_date_wise')->name('product_bulk_export.date_wise_download');
...
Route::post('/addresses/newAddressstore', 'AddressController@newAddressstore')->name('addresses.newAddressstore');
...
Route::post('sendMail', 'HomeContactController@html_email')->name('sendMail');
Route::post('sendMailAdmin', 'HomeContactController@sendMailAdmin')->name('sendMailAdmin');