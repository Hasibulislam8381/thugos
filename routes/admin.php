...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin']], function () {
    ...
    Route::post('/categories/nav', 'CategoryController@updateNavCategory')->name('categories.nav');
    ...
    /*New Route for copy products*/
    Route::get('/products/copy', 'ProductController@seller_products_copy')->name('products.seller.copy');
    Route::post('/products/copy-save', 'ProductController@seller_products_copy_store')->name('products.seller.copy_store');
    /*New Route for copy products*/
    ...
    Route::post('/all_orders/customer_rank', 'OrderController@customer_rank')->name('all_orders.customer_rank');
    ...
    Route::post('/bulk-order-send-pathao', 'OrderController@bulk_send_pathao')->name('bulk_send_pathao');
    Route::post('/bulk-order-send-steadfast', 'OrderController@bulk_send_steadfast')->name('bulk_send_steadfast');
    Route::post('/bulk_store', 'OrderController@bulk_store')->name('bulk_store');
    ...
    //Support_Ticket
    Route::get('stock-request/', 'SupportTicketController@stock_request')->name('stock_request.admin_index');
